...
export const metadata: Metadata = {
  ...
  description: "สมัครเป็นตัวแทนขายทัวร์กับ PayDee รับคอมมิชชั่นสูงถึง 2,000+ บาท/ทริป ไม่มีเป้ายอดขายขั้นต่ำ งานพาร์ทไทม์ทำที่บ้าน ทีมงานช่วยปิดการขาย มีระบบหลังบ้านครบครัน",
  keywords: [
    "ตัวแทนขายทัวร์",
    "คอมมิชชั่นทัวร์",
    "งานขายทัวร์",
  ...
  openGraph: {
    ...
    description: "สมัครเป็นตัวแทนขายทัวร์กับ PayDee รับคอมมิชชั่นสูงถึง 2,000+ บาท/ทริป ไม่มีเป้ายอดขายขั้นต่ำ งานพาร์ทไทม์ทำที่บ้าน",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "offers": {
                "@type": "Offer",
                "description": "โอกาสเป็นตัวแทนขายทัวร์ คอมมิชชั่นสูงถึง 2,000+ บาทต่อทริป ไม่มีขั้นต่ำ",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "เปิดรับสมัครตัวแทนขายทัวร์ รับคอมมิชชั่นสูงถึง 2,000+ บาทต่อทริป ไม่มีเป้ายอดขายขั้นต่ำ ทำงานที่บ้านได้ ทีมงานสนับสนุน",
